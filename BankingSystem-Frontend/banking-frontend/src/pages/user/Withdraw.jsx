...
export default function Withdraw() {
    ...
    const selectedAccount = accounts.find(a => a.accountNumber === formData.accountNumber)
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true)
        try {
            const res = await api.post('/api/accounts/withdraw', formData)
            setResult(res.data)
            toast.success(`Rs ${formData.amount} withdrawn successfully`)
        } catch (err) {
            const msg = err.response?.data?.error || 'Withdrawal failed'
            toast.error(msg)
        } finally {
            setLoading(false)
        }
            ...
            <main className="app-page">
                <div className="content-wrap">
                    <div className="page-title">
                        ...
                        <p>Withdraw from an active account with balance validation.</p>
                    </div>
                        ...
                        <div className="col-lg-6">
                            {result ? (
                                <section className="result-shell text-center">
                                    ...
                                    <h3 className="fw-bold mb-2">Withdrawal completed</h3>
                                    <p className="muted-text mb-4">Remaining balance</p>
                                ...
                                <section className="form-shell">
                                    <form onSubmit={handleSubmit}>
                                            ...
                                            <select
                                                ...
                                                {accounts.map(acc => (
                                                    <option
                                                        ...
                                                        {acc.accountNumber} - Rs {acc.balance.toFixed(2)}
                                        ...
                                        <button type="submit" className="btn-danger-soft w-100" disabled={loading}>
